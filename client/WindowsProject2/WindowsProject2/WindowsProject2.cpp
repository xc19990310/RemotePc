                     ...
                     _In_ int       nCmdShow)
{
    ...
    addr.sin_addr.S_un.S_addr = inet_addr("192.168.1.6");  //固定，写外网ip,或本地ip
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_COPYDATA:
    {
        ...
        pPkt->length = strlen(pStr) + 1;//仅仅表示数据长度，不包括结构体头部2个四字节
